...
module "__v4__" {
  # 1.20.0
  source = "git::https://github.com/pagopa/terraform-azurerm-v4?ref=elastic_app_resources-file-contents" // TODO change after merge of https://github.com/pagopa/terraform-azurerm-v4/pull/37
}