...
|------|-------------|------|---------|:--------:|
| <a name="input_azdo_iac_target_identities"></a> [azdo\_iac\_target\_identities](#input\_azdo\_iac\_target\_identities) | Set of AZDO managed identities principal ids for the target subscription that must have access to this target keyvault | `set(string)` | n/a | yes |
