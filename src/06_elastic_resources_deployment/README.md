...
| <a name="input_total_shards_per_node"></a> [total\_shards\_per\_node](#input\_total\_shards\_per\_node) | (Optional) Maximum number of  + replica shards to be stored on a node for each index. Default is 2. | `number` | `2` | no |
