...
|------|-------------|------|---------|:--------:|
| <a name="input_alert_channels"></a> [alert\_channels](#input\_alert\_channels) | Channels used to notify alerts | <pre>object({<br/>    jsm   = bool<br/>    email = bool<br/>    log   = bool<br/>    slack = bool<br/>  })</pre> | <pre>{<br/>  "email": false,<br/>  "jsm": false,<br/>  "log": true,<br/>  "slack": true<br/>}</pre> | no |
...
| <a name="input_app_connectors"></a> [app\_connectors](#input\_app\_connectors) | (optional) Map of <connector name>-<connector details> for additional connectors dedicated to app alerts. supports slack and jsm type | <pre>map(object({<br/>    type       = string<br/>    secret_key = string<br/>  }))</pre> | `{}` | no |
