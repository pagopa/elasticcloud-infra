...
|------|-------------|------|---------|:--------:|
| <a name="input_enabled_features"></a> [enabled\_features](#input\_enabled\_features) | Features Flag enabled | <pre>object({<br/>    kv = bool<br/>  })</pre> | <pre>{<br/>  "kv": false<br/>}</pre> | no |
