...
module "__v4__" {
  # https://github.com/pagopa/terraform-azurerm-v4/releases/tag/v1.19.0
  source = "git::https://github.com/pagopa/terraform-azurerm-v4?ref=ca45eeb380ddf51b0d53b80bab142932dd7f55b4"
}
