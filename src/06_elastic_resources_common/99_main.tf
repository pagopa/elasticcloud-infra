...
module "__v4__" {
  # https://github.com/pagopa/terraform-azurerm-v4/releases/tag/v1.12.0
  source = "git::https://github.com/pagopa/terraform-azurerm-v4?ref=ecd8b8b0d93e133111fa03d0150f779383520eb9"
}
